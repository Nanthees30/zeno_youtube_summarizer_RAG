...
import {
  UserIcon, AlertCircleIcon, SparklesIcon,
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {isUser  && <UserIcon size={14} color="var(--text-secondary)" />}
      ...
      <div style={{ maxWidth: '78%', minWidth: 0, display: 'flex', flexDirection: 'column', alignItems: isUser ? 'flex-end' : 'flex-start' }}>
        ...
        <p style={{
          ...
          color: isUser ? 'var(--text-secondary)' : isError ? 'var(--danger)' : 'var(--text-muted)',
                      ...
                      {parsed.source && (
                        <span style={{
                          ...
                          {parsed.source === 'transcript' ? (
                            <><VideoIcon size={11} /> From video</>
                          ) : (
                            <><SparklesIcon size={11} /> General knowledge</>
                          )}
                        </span>
                      )}
                    </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 5 }}>
            ...
            {hasSources && (
              ...
              >
                ...
                {sourcesOpen ? <ChevronUpIcon size={11} /> : <ChevronDownIcon size={11} />}
              </button>
            )}
            {message.model && (
  ...
  return (
    <div className="fade-slide-up" style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        <p style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-muted)', marginBottom: 5 }}>Zeno</p>
        <div style={{
          padding: '12px 16px',
          background: 'var(--bg-elevated)',
          border: '1px solid var(--border-strong)',
